defmodule CeducWeb.Landing.FooterComponent do
  ...
  def render(assigns) do
    ...
    <footer id="contact">
      ...
      <div class="w-full flex" aria-labelledby="footer-heading">
        <div class="mx-auto w-10/12 pb-8 ">
          <div class="mt-10 border-t border-gray-900/10 pt-8  lg:flex lg:items-center lg:justify-between">
            <div>
              <h3 class="text-sm font-semibold leading-6 text-gray-900">
                Suscríbete a nuestro newsletter
              </h3>
              <p class="mt-2 text-sm leading-6 text-gray-600">
                Serás el primero en recibir por correo las últimas novedades de
                CEDUC.
              </p>
            </div>
            <form class="mt-6 sm:flex sm:max-w-md lg:mt-0">
              ...
              <input
                ...
                autocomplete="email"
                required
                class="w-full min-w-0 appearance-none rounded-md border-0 bg-white px-3 py-1.5 text-base text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-prin sm:w-56 sm:text-sm sm:leading-6"
                placeholder="Enter your email"
              />
              <div class="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                <button
                  type="submit"
                  class="flex w-full items-center justify-center rounded-md bg-prin px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-secu focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-prin"
                >
                  Suscribir
                </button>
              </div>
